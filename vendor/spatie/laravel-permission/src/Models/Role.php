...
class Role extends Model implements RoleContract
{
    ...
    public static function create(array $attributes = [])
    {
        ...
        $params = ['name' => $attributes['name'], 'Estado' => $attributes['Estado'], 'guard_name' => $attributes['guard_name']];
        ...
        if (static::findByParam($params)) {
            throw RoleAlreadyExists::create($attributes['name'], $attributes['Estado'], $attributes['guard_name']);
        }
    ...
    public static function findByName(string $name, $guardName = null): RoleContract
    {
        ...
        $role = static::findByParam(['name' => $name, 'Estado' => $Estado, 'guard_name' => $guardName]);
    ...
    public static function findOrCreate(string $name, $guardName = null): RoleContract
    {
        ...
        if (! $role) {
            return static::query()->create(['name' => $name, 'Estado' => $Estado, 'guard_name' => $guardName] + (PermissionRegistrar::$teams ? [PermissionRegistrar::$teamsKey => getPermissionsTeamId()] : []));
        }
