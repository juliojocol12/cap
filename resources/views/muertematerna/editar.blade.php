@extends('layouts.app')
@section('title')
    Editar datos de Muertes Maternas
@endsection

@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Editar ficha de muerte materna</h3>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body" onkeypress="return pulsar(event)">
                            ...
                            {!! Form::model($muertematernas, ['method' => 'PATCH', 'route'=> ['muertematerna.update', $muertematernas->idMuerteMaterna]]) !!}
                            <div class="row">                            
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <a href="{{ route('muertematerna.index') }}" class="btn btn-danger mr-3">Volver</a>
                        </div>
