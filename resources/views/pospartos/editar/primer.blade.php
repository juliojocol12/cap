                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-4">                            
                                <div class="form-group">
                                    ...
                                    <div class="form-outline w-100 mb-4">
                                        <textarea class="form-control" id="ExamenGinecologico" name="ExamenGinecologico" style="height:60px; width: 100%; " maxlength="200">{{$fcevaluacionposparto->ExamenGinecologico}}</textarea>
                                     </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-4">                            
                                <div class="form-group">
                                    ...
                                    <div class="form-outline w-100 mb-4">
                                        <textarea class="form-control" id="Diagnostico" name="Diagnostico" style="height:60px; width: 100%; " maxlength="200">{{$fcevaluacionposparto->Diagnostico}}</textarea>
                                     </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-4">                            
                                <div class="form-group">
                                    ...
                                    <div class="form-outline w-100 mb-4">
                                        <textarea class="form-control" id="ConductaTratamiento" name="ConductaTratamiento" style="height:60px; width: 100%; " maxlength="200">{{$fcevaluacionposparto->ConductaTratamiento}}</textarea>
                                     </div>
                                </div>
                            </div>
