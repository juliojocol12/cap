                        ...
                        <div class="row ">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-3">                            
                                        <div class="form-group">
                                            ...
                                            <div class="form-outline w-100 mb-2">
                                                <textarea class="form-control" id="VacuncacionTdapMadre" name="VacuncacionTdapMadre" style="height:60px; width: 100%; " maxlength="20" placeholder="Ingrese dosis que se administra">{{$controlposparto->VacuncacionTdapMadre}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-3">                            
                                        <div class="form-group">
                                            ...
                                            <div class="form-outline w-100 mb-2">
                                                <textarea class="form-control" id="Medicamento" name="Medicamento" style="height:60px; width: 100%; " maxlength="45" placeholder="Describa el medicamento">{{$controlposparto->Medicamento}}</textarea>
                                            </div>
                                        </div>
                                    </div>
