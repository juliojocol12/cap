                        ...
                        <div class="row ">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" list="filtoIdFichas" id="filtoIdFicha" name="FCEvaluacionPosparto_id" placeholder="ingrese el DPI de la Madre" autocomplete="off">                                        
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-5">                            
                                        <div class="form-group">
                                            ...
                                            <div class="form-outline w-100 mb-4">
                                                ...
                                                <textarea class="form-control" id="ExamenGInecológico" name="ExamenGInecológico" style="height:60px; width: 100%; " maxlength="200" placeholder="Describa: hallazgos patológicos y otros"></textarea>
                                            </div>
                                        </div>
                                    </div>
