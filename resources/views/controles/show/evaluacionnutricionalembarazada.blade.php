        ...
        <div class="row ">
            ...
            <div class="col-xs-6 col-sm-6 col-md-2">
                ...
                <label for="">Peso</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="{{$controle->Pesolb}}" disabled>
                </div>                                       
            </div>
            ...
            <div class="col-xs-6 col-sm-6 col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="{{$controle->Talla}}" disabled>
                </div>                                       
            </div>
            ...
            <div class="col-xs-6 col-sm-6 col-md-2">
                <div class="form-group">
                    <label for="">CMB</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="{{$controle->CMB}}" disabled>
                </div>                                       
            </div>
            ...
            <div class="col-xs-6 col-sm-6 col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="{{$controle->Accionesicm}}" disabled>
                </div>                                       
            </div>
