                        ...
                        <div class="col-xs-6 col-sm-6 col-md-2">
                                ...
                                <div class="col-xs-1 col-sm-6 col-md-2">
                                    <div class="form-group">
                                        ...
                                        <option select">{{$controle->AbortoConsecutivo}}</option>
                                        @if ($controle->AbortoConsecutivo === 'Si')
                                ...
                                <div class="col-xs-1 col-sm-6 col-md-2">
                                    <div class="form-group">
                                        ...
                                        <option select">{{$controle->EmbarazoMultiples}}</option>
                                        @if ($controle->EmbarazoMultiples === 'Si')
                                        <option value="No">No</option>
                                        @else
                                        <option value="Si">Si</option>
                                        @endif
                                ...
                                <div class="col-xs-1 col-sm-6 col-md-2">
                                    <div class="form-group">
                                        ...
                                        <option select">{{$controle->PreEclampsia}}</option>
                                        @if ($controle->PreEclampsia === 'Si')
                                        <option value="No">No</option>
                                        @else
                                        <option value="Si">Si</option>
                                        @endif
                                ...
                                <div class="col-xs-1 col-sm-6 col-md-2">
                                    <div class="form-group">
                                        ...
                                        <option select">{{$controle->UltimoRNPesoCincolb}}</option>
                                        @if ($controle->PreUltimoRNPesoCincolbEclampsia === 'Si')
                                        <option value="No">No</option>
                                        @else
                                        <option value="Si">Si</option>
                                        @endif
                                ...
                                <div class="col-xs-1 col-sm-6 col-md-2">
                                    <div class="form-group">
                                        ...
                                        <option select">{{$controle->UltimoRNPesoSietelb}}</option>
                                        @if ($controle->UltimoRNPesoSietelb === 'Si')
                                        <option value="No">No</option>
                                        @else
                                        <option value="Si">Si</option>
                                        @endif
                                ...
                                <div class="col-xs-1 col-sm-6 col-md-2">
                                    <div class="form-group">
                                        ...
                                        <option select">{{$controle->ResultadoNormal}}</option>
                                        @if ($controle->ResultadoNormal === 'Si')
                                        <option value="No">No</option>
                                        @else
                                        <option value="Si">Si</option>
                                        @endif
                                ...
                                <div class="col-xs-1 col-sm-6 col-md-2">
                                    <div class="form-group">
                                        ...
                                        <option select">{{$controle->MetodoPlanificacionFamiliar}}</option>
                                        @if ($controle->MetodoPlanificacionFamiliar === 'Si')
                                        <option value="No">No</option>
                                        @else
                                        <option value="Si">Si</option>
                                        @endif
