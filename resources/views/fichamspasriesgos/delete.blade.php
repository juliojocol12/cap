...
<div class="modal fade" data-backdrop="false" data-keyboard="false" id="modal-delete-ficha" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <form action="{{ route('fichamspasriego.destroy', $fichamspasriego->idFichamspasriegos) }}" method="post">
    @csrf
    @method('DELETE')
    ...
    <div class="modal-content">
      ...
      ¿Desea eliminar el registro de la ficha clinica de {{$fichamspasriego->DatosPersonalesPacientes_id}} {{$fcprenatalpostparto->FCPrenatalPostparto_id}} ?
      </div>
